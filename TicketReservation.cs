...
namespace AirlineReservationSystemCSharp
{
    public partial class TicketReservation : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\DELL\OneDrive\Desktop\AirlineReservationSystemCSharp\AirlineReservationSystemCSharp\airline.mdf;Integrated Security=True;Connect Timeout=30");
            con.Open();
        ...
        {
            SqlConnection con = new SqlConnection(@"Server=ANIL;Database=AIRLINERESERVATIONSYSTEMCSHARP;Integrated Security=True;");
            con.Open();
